...
private func allLocalizedStringKeys(in bundle: [LocalizedBundle], table: String, file: StaticString = #file, line: UInt = #line) -> Set<String> {
    return bundle.reduce([]) { acc, current in
        guard
