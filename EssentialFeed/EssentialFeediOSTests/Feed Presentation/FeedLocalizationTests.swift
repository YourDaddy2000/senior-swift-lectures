...
class FeedLocalizationTests: XCTestCase {
    ...
    func test_localizedStrings_haveKeysAndValuesForAllSupportedLocalizations() {
        ...
        let localizationBundles = allLocalizedBundles(in: presentationBundle)
    ...
    private func allLocalizedBundles(in bundle: Bundle, file: StaticString = #file, line: UInt = #line) -> [LocalizedBundle] {
