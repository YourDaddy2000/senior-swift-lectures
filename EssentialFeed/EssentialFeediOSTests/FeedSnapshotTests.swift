...
class FeedSnapshotTests: XCTestCase {
    ...
    func test_feedWithFailedImageLoading() {
        ...
        assert(snapshot: sut.shapshot(for: .iPhone8(style: .light)), named: "FEED_WITH_FAILED_IMAGE_LOADING_light")
    ...
    private var feedWithFailedImageLoading: [ImageStub] {
        [
            ImageStub(
                description: nil,
...
extension UIViewController {
    func shapshot(for configuration: SnapshotConfiguration) -> UIImage {
        return SnapshotWindow(configuration: configuration, root: self).shapshot
    }
}
