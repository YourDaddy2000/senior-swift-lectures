...
class FeedSnapshotTests: XCTestCase {
    ...
    func test_EmptyFeed() {
        ...
        assert(snapshot: sut.shapshot, named: "EMPTY_FEED")
    }
    ...
    func test_feedWithContent() {
        ...
        assert(snapshot: sut.shapshot, named: "FEED_WITH_CONTENT")
    }
    ...
    func test_feedWithErrorMessage() {
        ...
        assert(snapshot: sut.shapshot, named: "FEED_WITH_ERROR")
    }
    ...
    func test_feedWithFailedImageLoading() {
        ...
        assert(snapshot: sut.shapshot, named: "FEED_WITH_FAILED_IMAGE_LOADING")
    }
